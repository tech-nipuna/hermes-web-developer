  ...
  return (
    <Float speed={2} rotationIntensity={0.6} floatIntensity={1}>
      <mesh ref={ref} scale={1.4}>
        ...
        <meshStandardMaterial color="#138808" wireframe transparent opacity={0.4} />
      </mesh>
    </Float>
  )
}
  ...
  return (
    <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden bg-brand">
      ...
      <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1 }}
        ...
        <p className="text-accent uppercase tracking-[0.4em] text-sm mb-4">Wyra Road, Khammam, Khammam</p>
        ...
        <div className="mt-12 flex justify-center gap-8 text-cream/70 text-sm">
          <span>★ 4.3 / 5 on Google</span>
          <span>|</span>
          <span>739 Reviews</span>
        </div>
      </motion.div>
    </section>
  )
