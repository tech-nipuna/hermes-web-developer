        ...
        {sent ? (
          ...
          <motion.form onSubmit={handleSubmit} initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}
            ...
            <select required value={room} onChange={e => setRoom(e.target.value)}
              ...
              <option value="king" className="text-gray-900">Deluxe King Room - rs.2,000</option>
              <option value="exec" className="text-gray-900">Executive Room - rs.2,000</option>
              <option value="suite" className="text-gray-900">Suite Room - rs.2,000</option>
            </select>
