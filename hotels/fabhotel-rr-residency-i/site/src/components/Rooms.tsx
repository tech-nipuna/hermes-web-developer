...
const rooms = [
  { name: 'Luxury Single', price: 'rs.1,500', size: '280 sqft', occupancy: '1 Guest', image: 'https://images.unsplash.com/photo-1590490360182-c33d655d4d43?w=800&q=80', amenities: ['King Bed', 'AC', 'TV', 'Wi-Fi', 'Mini Bar'] },
