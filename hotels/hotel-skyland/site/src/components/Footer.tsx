  ...
  return (
    <footer className="bg-brand border-t border-accent/30 py-12">
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-8 text-cream/80">
        <div>
          <h3 className="text-2xl font-heading text-accent mb-4">Hotel Skyland</h3>
        ...
        <div>
          ...
          <div className="space-y-3 text-sm">
            <p className="flex gap-3 items-start"><MapPin size={16} className="mt-0.5 shrink-0" /> NSP Camp, Khammam, Khammam, Telangana 507001</p>
      ...
      <div className="max-w-7xl mx-auto px-6 mt-10 pt-6 border-t border-ivory/20 text-center text-sm text-cream/60">
        © 2026 Hotel Skyland. All rights reserved.
      </div>
    </footer>
  )
}
