...
export default function About() {
  const stats = [
    { num: '4.7', label: 'Google Rating', desc: 'Based on 60 guest reviews' },
    { num: 'rs.1,100', label: 'Starting Rate', desc: 'Per night, excluding taxes' },
    { num: '60', label: 'Happy Guests', desc: 'Reviewed on Google Maps' },
  ]
  return (
      ...
      <div className="max-w-6xl mx-auto px-6">
        <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Nestled on prestigious NSP Camp, Khammam, Hotel Skyland stands as a beacon of luxury in the heart of Khammam, Telangana.
          </p>
        </motion.div>
