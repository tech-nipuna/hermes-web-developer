    ...
    <section id="reviews" className="py-24 bg-white">
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <div className="flex justify-center gap-4 mt-8">
          <button onClick={prev} className="w-12 h-12 rounded-full bg-brand text-cream flex items-center justify-center hover:bg-amber hover:text-brand transition-colors">
            <ChevronLeft size={20} />
          </button>
          <button onClick={next} className="w-12 h-12 rounded-full bg-brand text-cream flex items-center justify-center hover:bg-amber hover:text-brand transition-colors">
