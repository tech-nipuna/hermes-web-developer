    ...
    <section id="location" className="py-24 bg-brand/5">
      <div className="max-w-6xl mx-auto px-6">
        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          ...
          <p className="text-gray-600 text-lg">Conveniently located on NST Road, Khammam, in the heart of Khammam</p>
        </motion.div>
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">H.No: 15-9-543/1, NST Road, Khammam, Khammam, Telangana 507001</p>
              </div>
            </div>
            <div className="flex gap-4 items-start">
